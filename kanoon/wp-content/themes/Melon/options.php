...
*/
	...
	$options[] = array( "name" => "صفحه نخست",
						"type" => "heading");	
						
						
	$options[] = array( "name" => "منطقه زمانی",
						"desc" => "منطقه زمانی خود را انتخاب کنید",
						"id" => "w2f_timezone",
						"std" => "Asia/Tehran",
						"type" => "select",
						"options" => $timezones);			
	...
	$options[] = array( "name" => "دسته چشمک زن",
						"desc" => "دسته ای را برای قرار گیری در بخش چشمک زن انتخاب کنید",
						"id" => "w2f_flash_category",
						"type" => "select",
						"options" => $options_categories);						
						
	$options[] = array( "name" => "تعداد آیتم های موجود در چشمک زن",
						"desc" => "به عدد وارد کنید",
						"id" => "w2f_flash_count",
						"std" => "5",
						"type" => "text");								
						
						
	$options[] = array( "name" => "دسته برترین اخبار",
						"desc" => "دسته ای را برای نمایش خلاصه در صفحه نخست انتخاب کنید",
						"id" => "w2f_feature_category",
						"type" => "select",
						"options" => $options_categories);								
						
						
	$options[] = array( "name" => "بنرهای تبلیغاتی",
						"type" => "heading");		
																			//1
	...
	$options[] = array( "name" => "Banner 1 Image",
						...
						"id" => "w2f_banner1",
						"std" => get_template_directory_uri() . '/images/ad-serena.png',
						"type" => "text");
						
	$options[] = array( "name" => "Banner 1 Image alt tag",
						"desc" => "Enter your banner alt tag.",
						"id" => "w2f_alt1",
						"std" => "Serena Hosting Group",
						"type" => "text");		
	...
	$options[] = array( "name" => "Banner 2 Image",
						"desc" => "Enter your 125 x 125 banner image url here..",
						"id" => "w2f_banner2",
						"std" => get_template_directory_uri() . '/images/ad-mrleecher.png',
						"type" => "text");		
	...
	$options[] = array( "name" => "Banner 3 Image",
						"desc" => "Enter your 125 x 125 banner image url here..",
						"id" => "w2f_banner3",
						"std" => get_template_directory_uri() . '/images/ad-worldskills.png',
						"type" => "text");		

	$options[] = array( "name" => "Banner 3 Image alt tag",
						"desc" => "Enter your banner alt tag.",
						"id" => "w2f_alt3",
						"std" => "WorldSkills Iran TVTO",
						"type" => "text");		

	$options[] = array( "name" => "Banner 3 Url",
						"desc" => "Enter your banner-3 url here.",
						"id" => "w2f_url3",
						"std" => "http://www.skill.irantvto.ir/",
						"type" => "text");						
	...
	$options[] = array( "name" => "Banner 4 Image",
						"desc" => "Enter your 125 x 125 banner image url here..",
						"id" => "w2f_banner4",
						"std" => get_template_directory_uri() . '/images/ad-mixa.png',
						"type" => "text");		
