	...
	<div class="entry-header">
		...
		<aside class="entry-meta">
			<ul>
				...
				<li><?php _e( 'در', 'minimatica' ); ?> <time datetime="<?php the_time( 'Y-m-d' ); ?>"><?php the_time( get_option( 'date_format' ) ); ?></time></li>
				<li><?php _e( 'درباره ی', 'minimatica' ); ?> <?php the_category( ', ' ); ?></li>
				<?php edit_post_link( __( 'ویرایش', 'minimatica' ), '<li>', '</li>' ); ?>
			</ul>
