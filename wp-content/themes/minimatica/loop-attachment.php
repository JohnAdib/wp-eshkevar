				...
				<div class="post-top">
					<div class="entry-meta">
						<ul>
							...
							<li><?php _e( 'در', 'minimatica' ); ?> <?php the_date( get_option( 'date_format' ) ); ?></li>
							<?php if ( wp_attachment_is_image() ) : ?>
								<?php $metadata = wp_get_attachment_metadata(); ?>
								<li>
									<?php _e( 'سايز کامل', 'minimatica' );?>
									<a href="<?php echo wp_get_attachment_url(); ?>" title="<?php _e( 'پيوند به سايز کامل عکس', 'minimatica' ); ?>"><?php echo $metadata['width']; ?> &times; <?php echo $metadata['height']; ?></a>
									<?php _e( 'پيکسل', 'minimatica' ); ?>
								</li>
							<?php endif; ?>
						</ul>
					</div><!-- .entry-meta -->
